...
import { Modal, Form, Input, Button, Select, Row, Col, DatePicker, Upload, InputNumber, message } from "antd";
...
export default function VideoModal({
  ...
  const handleSubmit = async (values: any) => {
    try {
      ...
      if (result.success) {
        if (editingVideo) {
          setVideos((prev) => prev.map((v) => (v.id === result.data.id ? result.data : v)));
      ...
      <Form
        ...
        initialValues={
          editingVideo
            ? {
                ...editingVideo,
                startDate: editingVideo.startDate ? dayjs(editingVideo.startDate) : null,
                endDate: editingVideo.endDate ? dayjs(editingVideo.endDate) : null,
              }
            : {
